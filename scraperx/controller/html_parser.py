...
from scraperx.service import parser_service
...
async def toggle_task(rule_id: int, status: int) -> HtmlRuleToggleResponseEntity:
    ...
    return parser_service.toggle_start_stop(rule_id=rule_id, status=status)
